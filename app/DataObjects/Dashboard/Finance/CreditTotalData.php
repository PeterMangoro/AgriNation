...
class CreditTotalData
{
    ...
    {
        $raw_total =  Price::whereNot('currency','usd')->where('priceable_type','App\Models\Finance\Credit')->with('rate')->get();
        ...
        return new static (
            '$USD '. To2dp::of(($total+GetTotal::ofCredit('usd'))) .('(approx.)'),
            '$USD '. To2dp::of( GetTotal::ofCredit('usd')) ,
             To2dp::of(GetTotal::ofCredit('bond')) .' BOND',
            To2dp::of(GetTotal::ofCredit('rand')) .' RAND',
            To2dp::of(GetTotal::ofCredit('rtgs')) .' ZW(RTGS)',
