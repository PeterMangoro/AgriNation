...
<template>
  <form-section @submitted="updateChemicalDetail">
    <template #title> <p class="text-slate-100">  Update Chemical Documents</p> </template>

    <template #description>
      <p class="text-slate-50">  Upload Chemical related documents eg. User Manuals</p>
  ...
  <edit-document-list :documents="chemical.documents" path="attachments.show" />
  <edit-document-list
    :documents="chemical.trashed_documents"
