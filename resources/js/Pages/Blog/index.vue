  ...
  <app-layout title="Blogs">
    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 ">
      ...
      <div class="flex flex-wrap justify-between pb-2">
        ...
        />
        <span class="my-auto">
          <button-link :link="route('blogs.create')" class="bg-slate-600"
      ...
      <section class="relative overflow-hidden ">
        <div class="relative container px-4 mx-auto">
          <div class="max-w-5xl mx-auto">
            <div
              class="py-2 border-t-2 border-gray-400 "
            ...
            >
              <div class="flex flex-wrap lg:flex-nowrap items-center ">
                <div class="w-full lg:w-auto px-4 mb-8 lg:mb-0">
                  <img
                    class="block w-44 h-30 object-cover rounded"
                    :src="blog.image"
                    alt=""
                  />
                </div>
                <div class="w-full lg:w-9/12 px-4 mb-10 lg:mb-0 ">
                  <div class="max-w-2xl ">
                    ...
                    <span v-if="blog.update" class="block text-gray-400 mb-1">{{
                      blog.update + " (last update)"
                    }}</span>
                    ...
                    <div class="flex flex-wrap gap-2">
                      <p
                        ...
                        :key="tag"
                        class="border rounded-full w-fit px-1.5 border-black dark:border-green-500"
                      >
                        {{ tag }}
                      </p>
                    </div>
                ...
                <div class="w-full lg:w-auto px-4 ml-auto text-right">
                  <div class="flex space-x-1">
                    <ButtonLink
                      ...
                      >Read</ButtonLink
                    >
                    <ButtonLink class="" :link="route('blogs.edit', blog.uuid)"
                      >Edit</ButtonLink
                    >
                    <Button
