...
<template>
  <form-section @submitted="createFertilization">
    <template #title>
      <p class="text-slate-50">Add Fertilization</p>
    </template>

    <template #description>
      <p class="text-slate-50">Tell us about what your Fertilization</p>
    ...
    <template #form>
      ...
      <div  class="col-span-6 sm:col-span-6">
        <InputLabel for="fertilizers" value="Select Fertilizationed Chemical(s)" />
        <InputError class="mt-2" :message="form.errors.fertilizers" />
      ...
      <div  class="col-span-6 sm:col-span-6">
        <InputLabel for="plants" value="Select Fertilizationed Plant(s)" />
      ...
      <div  class="col-span-6 sm:col-span-6">
        <InputLabel for="locations" value="Select Fertilizationed Location(s)" />
...
const onChemicalChange = (val) => {
    val[0].checked === true
    ? form.fertilizers.push(val[0].id)
    : form.fertilizers.pop(val[0].id);
};
...
function createFertilization() {
  form.post(route("fertilizations.store"), {
    errorBag: "createFertilization",
    preserveScroll: true,
    onSuccess: () => {
