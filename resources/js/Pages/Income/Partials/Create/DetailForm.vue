...
<template>
  <form-section @submitted="createIncome">
    <template #title>
      <p class="dark:text-slate-50 ">Add Income</p>
    </template>

    <template #description>
      <p class="dark:text-slate-50">Tell us about what your Income</p>
    ...
    <template #form>
      ...
      <div class="col-span-6 sm:col-span-4">
        <input-label for="source" value="Source of Income" />
            <select
      ...
      <div class="col-span-6 sm:col-span-4">
        <input-label for="detail" value="Income Description" />
        <text-area
          id="detail"
          ref="detailInput"
          v-model="detail"
