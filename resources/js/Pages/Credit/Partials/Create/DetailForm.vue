...
<template>
  <form-section @submitted="createCredit">
    <template #title>
      <p class="text-slate-50">Add Credit (Zvandakwereta)</p>
    </template>

    <template #description>
      <p class="text-slate-50">Tell us about what your Credit</p>
