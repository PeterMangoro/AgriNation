...
<template>
  <form-section @submitted="updateLocationDetail">
    <template #title> <p class="text-slate-100">  Update Location Documents</p> </template>

    <template #description>
      <p class="text-slate-50">  Upload Location related documents eg. User Manuals</p>
  ...
  <edit-document-list :documents="location.documents" path="attachments.show" />
  <edit-document-list
    :documents="location.trashed_documents"
