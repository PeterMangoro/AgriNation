...
<template>
  <form-section @submitted="createPlant">
    <template #title> <p class="text-slate-50 underline"> Upload Plant Attachments</p> </template>
    ...
    <template #description>
      ...
      <p class="text-slate-50 mt-2">If your plant has a manual, you can upload it as a document</p>
      ...
      <p class="text-slate-50 mt-2">
        Categories are helpful in grouping your plants according to client
        preferences
      </p>
    </template>
