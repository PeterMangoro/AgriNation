...
<template>
  <form-section @submitted="createFertilizer">
    <template #title> <p class="text-slate-50 underline"> Upload Fertilizer Attachments</p> </template>
    ...
    <template #description>
      ...
      <p class="text-slate-50 mt-2">If your fertilizer has a manual, you can upload it as a document</p>
      ...
      <p class="text-slate-50 mt-2">
        Categories are helpful in grouping your fertilizers according to client
        preferences
      </p>
    </template>
