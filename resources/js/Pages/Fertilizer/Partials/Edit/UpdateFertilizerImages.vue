...
<template>
  <form-section @submitted="updateFertilizerDetail">
    <template #title> <p class="text-slate-100">  Update Fertilizer Images</p> </template>
  ...
  <update-image-card class="mt-2" :images="fertilizer.attachments" />
  <update-image-card class="mt-2" :images="fertilizer.trashed_images" />
</template>
<script setup>
import { ref } from "vue";
